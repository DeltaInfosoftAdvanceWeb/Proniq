    ...
    return (
        <section ref={containerRef} className="relative z-50 h-screen w-full bg-transparent overflow-hidden flex flex-col items-center justify-center perspective-[1000px]">
            ...
            <div ref={screenRef} className="relative z-50 w-full max-w-6xl aspect-video flex items-center justify-center transform-style-3d mt-32">
                <div className="relative w-full h-full bg-slate-950/60 backdrop-blur-xl border border-teal-500/40 rounded-xl p-5 shadow-[0_0_50px_rgba(20,184,166,0.15)] overflow-hidden flex flex-col [mask-image:linear-gradient(to_bottom,black_80%,transparent_100%)]">
                    {/* Grid effect overlay */}
                    ...
                    <div className="flex justify-between items-center mb-5 border-b border-teal-500/20 pb-3 relative z-10 shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-teal-50 font-bold tracking-widest text-sm">PRONIQ <span className="text-teal-400 font-normal">ANALYTICS</span></span>
                        </div>
                    ...
                    <div className="grid grid-cols-12 grid-rows-6 gap-4 relative z-10 flex-1 min-h-0">
                        ...
                        {/* KPI Cards (Top Row) */}
                        <div className="col-span-3 row-span-2 bg-slate-900/50 border border-teal-500/20 rounded-lg p-3 flex flex-col justify-between group hover:border-teal-500/40 transition-colors">
                        ...
                        <div className="col-span-6 row-span-4 bg-slate-900/50 border border-teal-500/20 rounded-lg p-4 relative overflow-hidden flex flex-col">
                        ...
                        <div className="col-span-6 row-span-4 bg-slate-900/50 border border-teal-500/20 rounded-lg p-0 overflow-hidden flex flex-col">
                        ...
                        {/* Bottom Right Stats */}
                        <div className="col-span-6 row-span-2 bg-slate-900/50 border border-teal-500/20 rounded-lg p-3 flex items-center justify-around">
