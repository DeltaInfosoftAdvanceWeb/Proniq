        ...
        <main className="min-h-screen bg-white text-gray-900">
            ...
            <section className="px-6 py-28 text-center bg-gradient-to-b from-gray-50 to-white">
                <div className="mx-auto max-w-4xl">
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                        ERP for the <span className="text-blue-600">Engineering Industry</span>
                    </h1>
                    <p className="mt-6 text-lg text-gray-600">
                        Manage complex engineering projects with precision planning, resource allocation, 
                        and real-time collaboration across teams.
                    </p>
            ...
            <section id="solutions" className="px-6 py-20 bg-gray-50">
                <div className="mx-auto max-w-6xl">
                    <h2 className="text-3xl font-semibold text-center mb-14">
                        Key Engineering ERP Capabilities
                    </h2>
                        ...
                        {[
                            {
                                ...
                                desc: "Organize and track engineering projects efficiently.",
                            },
                            {
                                title: "Resource Management",
                                desc: "Allocate and optimize engineering resources across projects.",
                            },
                            {
                                title: "Document Management",
                                desc: "Centralize technical drawings, specifications, and approvals.",
                            },
                            {
                                title: "Team Collaboration",
                                desc: "Enable seamless communication between distributed teams.",
                            },
                        ].map((feature) => (
                            <div
                                key={feature.title}
            ...
            <section className="px-6 py-20 text-center">
                <div className="mx-auto max-w-2xl">
                    <h2 className="text-3xl font-bold">Ready to Transform Your Engineering Operations?</h2>
                    <p className="mt-4 text-gray-600">
                        Join leading engineering firms using PRONIQ to deliver projects successfully.
                    </p>
                    <Link
                        href="/contact"
